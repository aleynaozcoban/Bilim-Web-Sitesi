<html>
<head>
<title>NASA, GOES-U Uydusunu Fırlatmak İçin SpaceX’in Falcon Heavy Roketini Seçti</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/4.jpg) ;z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/STP-2-Successful-Launch-1024x683.jpg" alt="" style="margin: 50px 0 0 330px; width: 800px;">
  <br>
