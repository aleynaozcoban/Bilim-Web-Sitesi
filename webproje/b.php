<html>
<head>
<title>Hubble Uzay Teleskobunu Tanıyalım</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<body>
<div style="width:100%; height:3500px;">
<div class="header">
<div class="logo"></div>
<div class="arama">
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/j.jpg) ;z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/HST-SM4.jpeg" alt="" style="margin: 30px 0 0 390px;">
