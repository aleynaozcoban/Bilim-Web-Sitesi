<html>
<head>
<title>NASA, dünyanın en büyük uzay teleskobu James Webb’i uzaya fırlattı</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/2.jpg) ;z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/yaratlıs.jpeg" alt="" style="margin: 50px 0 0 330px; width: 800px;">
  <br>
  <p style="color: black; font-size:35px;display:inline-block; margin-left:25%; height: 300px; text-align: center;"><i>Yaratılış Sütunları</i></p>
