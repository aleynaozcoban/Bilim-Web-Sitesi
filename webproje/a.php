<html>
<head>
<title>Yuri Gagarin, 60 yıl önce ilk insanlı uzay uçuşunu hangi şartlar altında gerçekleştirdi?</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/3gagarin.jpg);z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/vostok-1.jpg" alt="" style="margin: 30px 0 0 250px;">
