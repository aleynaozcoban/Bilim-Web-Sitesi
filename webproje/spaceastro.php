<html>
<head>
<title>SpaceX, ikinci kez uzay istasyonuna astronot gönderdi</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/6.jpg) ;z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
