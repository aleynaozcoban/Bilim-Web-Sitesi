...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/mike-massimino.jpg);z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <iframe width="560" height="315"  src="https://www.youtube.com/embed/UetwO3uLkZs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen
    style="margin: 25px 0 20px 450px ; border:5px solid bisque"></iframe>
  ...
  <div class="footer">
    ...
    <div class="logo2"></div>
			<div id="kutu">
				<b>Sayfalar</b>
				<ul>
                <a href="index2.php"><li>Ana Sayfa</li></a>
			    <a href=""><li>Hakkımızda</li></a>
				<a href="haber.php"><li>Haberler</li></a>
				<a href="bilgi.php"><li>Bilgiler</li></a>
