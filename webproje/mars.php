...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/mars-shutterstock_16_9_1621241346.jpg);z-index: 2; background-position:center; box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/803401-576848569.jpg" alt="" width="600px" style="margin:30px 0 0 480px;">
  ...
  <div class="footer">
    ...
    <div class="logo2"></div>
			<div id="kutu">
			    ...
			    <a href="hakkımızda.php"><li>Hakkımızda</li></a>
