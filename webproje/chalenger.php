<html>
<head>
<title>Challenger Uzay Mekiği Kazası Hakkında Bilmediğiniz 5 Şey</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/tarihi_olaylar_challenger-jpg_897591276_1430663321.jpg);  background-repeat: no-repeat;z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/challengerekip-scaled.jpg" width="600px"alt="" style="margin: 30px 0 0 480px;">
