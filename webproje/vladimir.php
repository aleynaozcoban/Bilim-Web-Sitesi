<html>
<head>
<title>Bir Uzay Uçuşu Sırasında Hayatını Kaybeden İlk İnsan: Vladimir Komarov</title>
<style type="text/css">
*{margin: 0; padding: 0;}
...
<div class="ust"></div>
    <div style="width: 600px ; height:500px;  margin: -300px auto 0 auto; background-image:url(images/vladimirko.jpg); background-position:center;background-repeat:no-repeat;z-index: 2;  box-shadow:0 2px 12px rgb(0 0 0 / 12%);">
</div>
<div class="ensol">
<div class="menu">
      <ul>
...
?>
  ...
  <img src="images/s-dce1f0710e4f90e61c04d876cc5f761ccbfd926b.webp" alt="" style="margin: 30px 0 0 500px;">
